---
name: clean-code
description: Principios de Robert C. Martin para transformar código que funciona en código limpio.
---
...
- **Explain Yourself in Code**:vs
    
    ```python
    # Check if employee is eligible for full benefitsif employee.flags & HOURLY and employee.age > 65:
    ```
